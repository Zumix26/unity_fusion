...
namespace Example.BasicMovement
{
    ...
    public sealed class BasicPlayer : NetworkBehaviour
    {
        ...
        public void SetupController(GameObject target, RuntimeAnimatorController runtimeAnimatorController)
        {
            _avatar = target;
            ...
            if (_avatar.GetComponent<NetworkMecanimAnimator>() != true)
            {
             
                var networkAnimator=_avatar.AddComponent<NetworkMecanimAnimator>();
