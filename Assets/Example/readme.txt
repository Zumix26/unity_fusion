...
2) Physics.ComputePenetration() returns incorrect penetration vector for TerrainCollider if the KCC overlaps trees, completely ignoring them.
As a workaround, extra capsule cast is needed (not yet implemented as default feature).
